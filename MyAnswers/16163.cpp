...
template<typename String = std::string, int MAX_STRING_LENGTH = 2'000'000, int INDEX_SIZE = 26>
class PalindromeTree {
    ...
    void append(int pos) {
        ...
        while (true) {
            ...
            if (pos - 1 - cur_len >= 0 && str[pos - 1 - cur_len] == str[pos]) break;
        ...
        while (true) {
            cur = tree[cur].sfxlink;
            cur_len = tree[cur].len;
            if (pos - 1 - cur_len >= 0 && str[pos - 1 - cur_len] == str[pos]) {
...
public:
    ...
    [[nodiscard]]
    std::size_t size() const { return total - 2; }
