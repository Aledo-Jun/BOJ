...
int32_t main() {
    ...
    for (int i = 0; i < m; i++) {
        ...
        if (bb == 'B') b = -b;
        if (cc == 'B') c = -c;
        g[-a + n].emplace_back(b + n, 1);
        g[-b + n].emplace_back(a + n, 1);
        g_r[b + n].emplace_back(-a + n, 1);
        g_r[a + n].emplace_back(-b + n, 1);
        g[-b + n].emplace_back(c + n, 1);
        g[-c + n].emplace_back(b + n, 1);
        g_r[c + n].emplace_back(-b + n, 1);
        g_r[b + n].emplace_back(-c + n, 1);
        g[-a + n].emplace_back(c + n, 1);
        g[-c + n].emplace_back(a + n, 1);
        g_r[c + n].emplace_back(-a + n, 1);
        g_r[a + n].emplace_back(-c + n, 1);
    }
